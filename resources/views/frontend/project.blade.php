...
@section('description')5988创业商机网{{$title}}频道实时发布更新最新{{$title}}信息及{{$title}}品牌资讯。包含行业最全{{$title}}加盟项目及品牌。{{$title}}的各类费用投资和成本预算 @stop
...
<div class="main clearfix">
    ...
    <div class="w260">
        ...
        <div class="bn260"><a href="javascript:;" target="_self"><img src="/reception/images/temp/bn6.jpg" width="260" height="295" alt=""/></a></div>
...
//            alert("项目对比最多可选三个!");
        ...
        bybReset.bind("click", function(){
            selectedplan.html('');
            $.cookie('prosion',null,{path:'/',domain:'www.zhaji.5988.com'});
            proLayer.hide();
