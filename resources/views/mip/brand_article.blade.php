...
@section('main_content')
    ...
    <div class="brand_detail">
        ...
        <div class="brand_tit" id="js_join_1" >@if(!empty($thisarticleinfos->article->ppjstitle))  <h3 class="tit">{{$thisarticleinfos->article->ppjstitle}}</h3> @else <span class="tit">【{{$thisarticleinfos->article['brandname']}}】<em>品牌介绍</em></span>  @endif</div>
